...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`${width} bg-[#0e0e1a] border-r border-white/5 hidden md:flex flex-col flex-shrink-0 z-50 overflow-hidden transition-all duration-200 min-h-screen sticky top-0 bg-[#0e0e1a]`}
